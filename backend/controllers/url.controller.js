...
// const jwt = require('jsonwebtoken'); // Ensure jsonwebtoken is imported for login/register tokens
...
//     // Generate JWT token matching your authorization lifecycle setup
...
// // ─── 3. FORGOT PASSWORD ACTION CONTROLLER ────────────────────────────────────
...
//     // Set up Nodemailer transporter using your backend environment configurations
...
//             <a href="${resetUrl}" style="display: inline-block; padding: 12px 24px; background-color: #008080; color: white; text-decoration: none; border-radius: 6px; font-weight: bold;">Reset Password</a>
//           </div>
...
// // ─── 4. RESET PASSWORD SUBMIT ACTION CONTROLLER ──────────────────────────────
// exports.resetPassword = async (req, res) => {
//   const { password } = req.body;
//   const { token } = req.params; // Correctly pulled out from matching url query params
...
//       resetPasswordExpires: { $gt: Date.now() } // Token expiration token check
//     });
...
//     // Clear tracking fields completely out of the Document record
